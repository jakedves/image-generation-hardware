...
class FastMiniESPCN(FloatESPCN):
    def __init__(self, upscale_factor: int = 2, channels: int = 3):
        super(FastMiniESPCN, self).__init__(upscale_factor=upscale_factor, num_channels=channels)
...
class FastMiniQuantESPCN(QuantESPCN):
    def __init__(self,
        ...
        super(FastMiniQuantESPCN, self).__init__(
